          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd @click="changeCheck(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)" 
                changepirce="0" 
                :class="{active:spuSaleAttrValue.isChecked === '1'}" 
                v-for="(spuSaleAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id">{{spuSaleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
import { mapState,mapGetters } from 'vuex'
  ...
  export default {
    ...
    methods:{
      ...
      changeCheck(spuSaleAttrValue,spuSaleAttrValueList){
